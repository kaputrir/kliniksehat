...
<head>
  ...
  <title>Login Pasien Klinik Sehat</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login Pasien</h1>
                  </div>
                  <form action="<?php echo base_url()."index.php/depan/proses_login_pasien"; ?>" method="POST">
                  ...
                  <div class="text-center">
                    <a class="small" href="index.php#contact">Daftar Pasien</a>
                  </div>
                </div>
              </div>
            </div>
